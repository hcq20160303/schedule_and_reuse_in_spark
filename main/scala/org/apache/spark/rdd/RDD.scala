...
//    }
   ...
   * ----------- hcq add code -------------
   */
  var indexOfnodesList: Int = 0          // use to find the coordinate SimulateRDD
  var indexOfleftInNodesList: Int = -1   // use to find the first leaf node in a DAG-Tree which root is this RDD
  var transformation: String = ""
  var function: String = ""
  var isCache = false       // use to judge a job which the finalRDD is this RDD whether generated by RDDShare
  var fromCache = false     // use to judge this RDD whether need to cache when RDDShare involved getCacheRDD() methond
